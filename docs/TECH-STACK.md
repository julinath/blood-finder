...
উ: Direct request-এ রক্তদাতা নিজে "রক্ত দিয়েছি" নিশ্চিত করেন — একটা atomic DB function request বন্ধ করে donation record লেখে; trigger সংখ্যা বাড়ায়। Emergency-তে উল্টো — requester নিশ্চিত করেন কে দিয়েছেন। দুই পক্ষের সম্মতি ছাড়া donation count বাড়ে না।
