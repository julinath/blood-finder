...
const FACTS = [
  ...
  },
  {
    num: 3,
    unit: 'জীবন',
    desc: '১ ব্যাগ রক্তে বাঁচতে পারে ৩টি পর্যন্ত মূল্যবান জীবন।',
  },
  {
    num: 10,
    unit: 'মিনিট',
    desc: 'এক ব্যাগ রক্ত দিতে সময় লাগে মাত্র ১০–১৫ মিনিট — খুবই সহজ ও নিরাপদ।',
  },
] as const
    ...
    <section className="bg-red-50/60 border-y border-red-100">
      <div className="max-w-6xl mx-auto px-4 py-14">
        <SectionHeading
          ...
          subtitle="ছোট্ট একটি সিদ্ধান্ত, একটি জীবন। আপনার রক্তই হতে পারে কারো বাঁচার আশা।"
        />
