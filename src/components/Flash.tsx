...
> = {
  ...
  'request-accepted': {
    type: 'success',
    text: 'রিকোয়েস্ট গ্রহণ করেছেন। রক্তদানের পর রিকোয়েস্টকারী “রক্ত পেয়েছি” নিশ্চিত করবেন।',
  },
  'request-completed': {
    type: 'success',
    text: 'ধন্যবাদ! রক্তদান নিশ্চিত হয়েছে — রক্তদাতার হিসাবে যোগ হলো এবং রিকোয়েস্ট সম্পন্ন। 🩸',
  },
  'request-declined': {
    type: 'success',
