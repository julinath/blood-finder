// The 64 districts of Bangladesh (English names, common spelling).
// Used for structured location matching in donor profiles + emergency requests.
...
export function isDistrict(value: unknown): value is District {
  return (
    typeof value === 'string' && (DISTRICTS as readonly string[]).includes(value)
  )
}
